 ...
 * 添加小车
 */
const wsAddCar = new WebSocket('ws://192.168.0.100:8080/websocket');
 ...
 * 添加障碍物
 */
const wsAddBlock = new WebSocket('ws://192.168.0.100:8080/websocket');
...
const wsLogic = new WebSocket('ws://192.168.0.100:8080/websocket');
 ...
 * 暂停探索
 */
const wsPause = new WebSocket('ws://192.168.0.100:8080/websocket');
 ...
 * 结束探索
 */
const wsEnd = new WebSocket('ws://192.168.0.100:8080/websocket');
 ...
 * 清空地图
 */
const wsClear = new WebSocket('ws://192.168.0.100:8080/websocket');
...
const wsUserManage = new WebSocket('ws://192.168.0.100:8080/websocket');
...
function deleteUser(userAccount) {
	...
	const wsUserDelete = new WebSocket('ws://192.168.0.100:8080/websocket');
...
function modifyUser(userAccount) {
	...
	const wsUserModify = new WebSocket('ws://192.168.0.100:8080/websocket');
...
let startTime;
var index=0;
const wsTime = new WebSocket('ws://192.168.0.100:8080/websocket');
